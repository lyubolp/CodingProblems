...
def reverse_extrapolate_sequences(sequences: list[list[int]]) -> int:
    return reduce(lambda acc, seq: seq[0] - acc, reversed(sequences), 0)
...
if __name__ == "__main__":
    ...
    for sequence in history_sequences:
        ...
        results.append(reverse_extrapolate_sequences(sequences))
