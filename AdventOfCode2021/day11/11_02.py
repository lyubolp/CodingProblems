...
def step(energy: List[List[int]]) -> Tuple[List[List[int]], bool]:
    ...
    return energy, (count_flashed(energy) == len(energy) * len(energy[0]))
...
if __name__ == "__main__":
    ...
    steps = 0
    while not is_all_flashed:
        steps += 1
        energy, is_all_flashed = step(energy)
